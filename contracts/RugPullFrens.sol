...
contract RugPullFrens is ERC721Enumerable, Ownable, EIP712 {
    ...
    // Sales variables
    // ------------------------------------------------------------------------
    uint256 public MAX_FRENS = 100;
    uint256 public MINTED_RESERVED_FRENS = 0;
    uint256 public constant RESERVED_FRENS = 0;

    uint256 public MAX_MINT_PER_TX = 20; // Max number of token can be minted per tx
    uint256 public FREN_PRICE = 0 ether; //price for minting on Presale and Sale period

    uint256 private publicSaleTimestamp = 1642665008; // Public Sale start time in epoch format
    
    
    // Treasury addresses
    // ------------------------------------------------------------------------
    address private _treasury = 0xCBb11DEa1EB91173f4bf3DE34230aCe8Fa740073; // address where ether Withdraw to
